...
DistLoss = DIST(beta=1.0, gamma=1.0, tau=1.0)
...
def trainOneEpoch(model, Teacher, trainloader, optimizer):
    model.train()
    Teacher.eval()
    Nsamples = 0
    Loss = 0
...
def main(params):
    ...
    for epoch in range(params.num_epochs):
        TrainRes = trainOneEpoch(model, Teacher, trainloader, optimizer)
