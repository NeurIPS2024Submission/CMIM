...
def trainOneEpoch(model, Teacher, trainloader, CElossFn, KLlossFn, optimizer, omega):
    model.train()
    Teacher.eval()
    Nsamples = 0
    Loss = 0
...
def main(params):
    ...
    for epoch in range(params.num_epochs):
        TrainRes = trainOneEpoch(model, Teacher, trainloader, CElossFn, KLlossFn, optimizer, omega)
